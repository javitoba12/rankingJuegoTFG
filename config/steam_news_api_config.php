...
return [
    ...
    //si existe la variable STEAM_APP_ID, y en caso de no existir, uso el valor por defecto para esa variable (582010, la id de monster hunter en steam), lo 
    //mismo aplica al resto de variables que devuelvp en este .config
